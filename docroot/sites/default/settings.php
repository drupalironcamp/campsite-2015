 ...
 *
 */
$drupal_hash_salt = 'Y8CbrhYPSIA6Boh-G6e45b-6Rulzbradw1E2Up2cqCs';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalironcamp_dev_default.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalironcamp_dev_default.inc');
//</DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/drupalironcamp/drupalironcamp-settings.inc');
}
